...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_casuallife1334-sketch_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_casuallife1334-sketch_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.PatchTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Today is gonna be a good day"
                },
                "title": {
                    "type": "string",
